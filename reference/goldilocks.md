...
exponential hazard model. The method can be used for a confirmatory
trial to select a trial's sample size based on accumulating data. During
accrual, frequent sample size selection analyses are made and predictive
...
Goldilocks trial design, as it is constantly asking the question, **“Is
the sample size too big, too small, or just right?”**

...
where and why enrollment stopped, while `plot_sim_decisions()` shows how the
two predictive probabilities map to the decision regions at each look.
...
The three simulation plots answer different questions. `plot_sim_stopping()`

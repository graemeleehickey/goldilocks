...
-   `plot_sim_stopping()` expands one scenario into the distribution of selected
    sample sizes and stopping reasons.
...
it increases the output size. It is therefore usually most useful for selected
scenarios after a broad operating-characteristic grid has been screened.

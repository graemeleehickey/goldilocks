...
For a single scenario, `plot_sim_stopping()` shows the marginal probability of
stopping at each enrolled sample size, with the fill identifying expected
success, futility, or reaching the maximum sample size.

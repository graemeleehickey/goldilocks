...
-   **`plot_sim_stopping()`**: Visualizes stopping outcomes and enrolled sample sizes across simulated trials.
...
-   **`analyse_data()`**: Applies the chosen analysis method (`logrank`, `cox`, `bayes-surv`, `bayes-bin`, or `chisq`) to an (imputed) dataset.

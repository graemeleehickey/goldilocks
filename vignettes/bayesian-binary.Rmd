...
identical count state within the same interim look has an identical result and
is evaluated once. With `bin_method = "mc"`, every replicate is still analyzed
with fresh `N_mcmc` beta-posterior draws; repeated states are not reused. This
